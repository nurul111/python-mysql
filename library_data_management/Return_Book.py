...
class ret(Tk):
    def __init__(self):
        ...
        Label(self, text='Return Book',bg='#005D5C', fg='Yellow',font=('Courier new', 25, 'bold')).place(x=100,y=30)
        Label(self, text='Enter Book ID',bg='#005D5C',fg='white', font=('Comic Scan Ms', 15, 'bold')).place(x=20, y=120)
        Entry(self, textvariable=a, width=40).place(x=165, y=124)
        Button(self, text="Return", width=15,bg='#005D5C',fg='white',font=('Courier new',12,'bold') ,command=qui).place(x=150, y=180)
ret().mainloop()